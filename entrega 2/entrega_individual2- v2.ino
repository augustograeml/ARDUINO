...
void loop()
{
 int apertou_um = 0, apertou_dois = 0, apertou_tres = 0;
 int led_sorteado = sorteio();
  ...
  apertou_um = digitalRead(5);
  apertou_dois = digitalRead(4);
  apertou_tres = digitalRead(3);
    
 
  Serial.println(apertou_um);
  
  if(led_sorteado - 8 == 5 && apertou_um && !apertou_dois && !apertou_tres)
  {
  ...
  else if (led_sorteado - 8 == 4 && !apertou_um && apertou_dois && !apertou_tres)
  {
    digitalWrite(led_sorteado, HIGH);
    delay(2000);
    digitalWrite(led_sorteado, LOW);
  ...
  else if(led_sorteado - 8 == 3 && !apertou_um && !apertou_dois && apertou_tres)
  {
  	digitalWrite(led_sorteado, HIGH);
    delay(2000);
    digitalWrite(led_sorteado, LOW);
